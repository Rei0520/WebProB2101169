    ...
    <main>
        ...
        <form method="POST" action="procRegistration.php" class="form-signin">
            <div class="text-center mb-4">
              <h1 class="mb-3 font-weight-bold">Employee Menu</h1>
              <!--show user name -->
			        <h3>Logging in :  <?php  echo $loggedinUser; ?></h3>

            </div><!--button for submit FWA Request and Update Daily schedule-->
			        <a href="submitFWARequest.php" class="btn btn-outline-secondary btn-lg btn-block"> Submit FWA Request </a>
		        	<a href="submitDailySchedule.php" class="btn btn-outline-secondary btn-lg btn-block"> Update Daily Schedule</a>
          </form>
		</div>
    </main>
