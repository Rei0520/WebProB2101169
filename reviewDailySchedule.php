...
<html lang="en">
  <head>
    ...
    <title> Review Daily Schedule </title>
  </head>
  <body class="bg-light">
  	<header>
    ...
    <main>
        ...
        <form method="POST" action="procreviewDailySchedule1.php" class="form-signin">
        <div class="text-center mb-4">
              <h1 class="mb-3 font-weight-bold">Select Work Date to Review</h1>
         </div>
          <!--input for date-->
