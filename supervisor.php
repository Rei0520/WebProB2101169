    ...
    <main>
        ...
        <form method="POST" action="procRegistration.php" class="form-signin">
            <div class="text-center mb-4">
              <h1 class="mb-3 font-weight-bold">Supervisor Menu</h1>
              <!--show user name-->
			        <h3>Logging in  <?php  echo $loggedinUser; ?></h3>
            </div>
      <!--button for Review FWA Request, Review Employee Schesule, and View FWA Analytics  -->
			<a href="procreviewFWARequest.php" class="btn btn-outline-secondary btn-lg btn-block"> Review FWA Request </a>
			<a href="reviewDailySchedule.php" class="btn btn-outline-secondary btn-lg btn-block"> Review Employee Schesule</a>
